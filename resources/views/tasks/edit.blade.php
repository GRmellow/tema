...
<div class="wrapper" id="app">
   ...
   <div class="content-wrapper">
       ...
       <section class="content-header">
               ...
               <h1>Edit Task</h1>
               {!! Form::open(['action' => ['PostsController@update', $task->id], 'method' => 'POST']) !!}
               <div class="form-group">
                       {{Form::label('tname', 'Task name')}}
                       {{Form::text('name', $task->name, ['class' => 'form-control', 'placeholder' => 'Insert a value'])}}
                   </div>
                   <div class="form-group">
